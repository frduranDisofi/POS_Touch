...
Public Class RPT_VentasDiarias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "delevery.RPT_VentasDiarias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_VentasDiarias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_VentasDiarias = New RPT_VentasDiarias()
        rpt.Site = Me.Site
        Return rpt
    End Function
