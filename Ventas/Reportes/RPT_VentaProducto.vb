...
Public Class RPT_VentaProducto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "delevery.RPT_VentaProducto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_VentaProducto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_VentaProducto = New RPT_VentaProducto()
        rpt.Site = Me.Site
        Return rpt
    End Function
