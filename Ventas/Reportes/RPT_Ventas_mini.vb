...
Public Class RPT_Ventas_mini
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "delevery.RPT_Ventas_mini.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_Ventas_mini
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_Ventas_mini = New RPT_Ventas_mini()
        rpt.Site = Me.Site
        Return rpt
    End Function
