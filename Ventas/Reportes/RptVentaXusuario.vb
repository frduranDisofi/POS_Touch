...
Public Class RptVentaXusuario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "delevery.RptVentaXusuario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptVentaXusuario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptVentaXusuario = New RptVentaXusuario()
        rpt.Site = Me.Site
        Return rpt
    End Function
