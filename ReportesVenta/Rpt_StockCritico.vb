...
Public Class Rpt_StockCritico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "delevery.Rpt_StockCritico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_StockCritico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_StockCritico = New Rpt_StockCritico()
        rpt.Site = Me.Site
        Return rpt
    End Function
