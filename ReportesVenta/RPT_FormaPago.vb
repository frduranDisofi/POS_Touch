...
Public Class RPT_FormaPago
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "delevery.RPT_FormaPago.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_FormaPago
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_FormaPago = New RPT_FormaPago()
        rpt.Site = Me.Site
        Return rpt
    End Function
