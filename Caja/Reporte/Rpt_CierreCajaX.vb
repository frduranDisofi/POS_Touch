...
Public Class Rpt_CierreCajaX
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "delevery.Rpt_CierreCajaX.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_CierreCajaX
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_CierreCajaX = New Rpt_CierreCajaX()
        rpt.Site = Me.Site
        Return rpt
    End Function
